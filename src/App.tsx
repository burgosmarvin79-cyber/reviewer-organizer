...
function ReviewPage() {
  ...
  const waitingForScheduledRepeat = mode === 'flashcards' && queuedCurrent !== undefined && isFlashcardRepeatAt(pool, index) && !isQuestionDue(queuedCurrent, new Date(reviewNow))
  const current = waitingForScheduledRepeat ? undefined : queuedCurrent
